...
//	}
	...
	public String decrypt(String cipher) {
		byte[] dec = decrypt(Base64.decodeBase64(cipher));
		return new String(dec);
	}
	public String encrypt2HexString(String msg) {
		byte[] enc = encrypt(msg.getBytes());
		return Hex.encodeHexString(enc);
	}
	public String decryptHex(String cipher) throws DecoderException {
		byte[] dec = decrypt(Hex.decodeHex(cipher.toCharArray()));
		return new String(dec);
	}
}
